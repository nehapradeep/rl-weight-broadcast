...
# Pattern: rank N connects to rank N+8
# Node 0 has ranks 0-7 (training)
# Node 1 has ranks 8-15 (inference)

if rank < 8:
    # Training ranks (0-7) - will connect
    target_rank = rank + 8
    ...
    # Inference ranks (8-15) - will accept
    source_rank = rank - 8
